...
class Trend {
  ...
  factory Trend.fromJson(Map<String, dynamic> j) => Trend(direction: j['direction'] as String, delta: _int(j['delta']));
...
class GameChip {
  const GameChip({required this.id, required this.slug, required this.name, required this.category});
  factory GameChip.fromJson(Map<String, dynamic> j) =>
      GameChip(id: j['id'] as String, slug: j['slug'] as String, name: j['name'] as String, category: j['category'] as String);
  final String id;
  final String slug;
  final String name;
...
class RankingsScope {
  const RankingsScope({required this.game, required this.region, required this.metric});
  factory RankingsScope.fromJson(Map<String, dynamic> j) =>
      RankingsScope(game: j['game'] as String?, region: j['region'] as String?, metric: j['metric'] as String);
  final String? game;
  final String? region;
...
class PageInfo {
  const PageInfo({required this.page, required this.totalPages, required this.total, required this.perPage});
  factory PageInfo.fromJson(Map<String, dynamic> j) =>
      PageInfo(page: _int(j['page']), totalPages: _int(j['totalPages']), total: _int(j['total']), perPage: _int(j['perPage']));
  final int page;
...
class RankingsStats {
  const RankingsStats({required this.playersRanked, required this.gamesIncluded, required this.totalMatches, required this.prizesAwarded});
...
class RankingsMe {
  ...
  factory RankingsMe.fromJson(Map<String, dynamic> j) => RankingsMe(row: _opt(j['row'], RankingRow.fromJson));
  final RankingRow? row;
}

class SeasonSummary {
  const SeasonSummary({required this.id, required this.slug, required this.name, required this.startDate, required this.endDate});
...
class SeasonLeaderboardRow {
  ...
  factory SeasonLeaderboardRow.fromJson(Map<String, dynamic> j) => SeasonLeaderboardRow(
...
class SeasonGame {
  ...
  factory SeasonGame.fromJson(Map<String, dynamic> j) => SeasonGame(
        ...
        tierLabels: SeasonTierLabels.fromJson(j['tierLabels'] as Map<String, dynamic>),
      );
  final String gameId;
...
class Placing {
  ...
  factory Placing.fromJson(Map<String, dynamic> j) => Placing(id: j['id'] as String, name: j['name'] as String);
  final String id;
  final String name;
}
...
class AwardOption {
  const AwardOption({required this.gameId, required this.gameLabel, required this.winner, required this.metricValue});
...
class CategoryAward {
  const CategoryAward({required this.category, required this.label, required this.metricLabel, required this.options});
...
class HofAwards {
  const HofAwards({required this.mvp, required this.goldenBoot, required this.categories});
...
class HofChampions {
  const HofChampions({required this.championsCup, required this.masters, required this.communityClub, required this.open});
...
class HallOfFame {
  const HallOfFame({required this.games, required this.selectedGame, required this.awards, required this.champions, required this.bronze});
